...
Plug 'rishi-opensource/vim-claude-code', { 'tag': 'v1.3.1' }
```
...
> ```sh
> cd ~/.vim/bundle/vim-claude-code && git checkout v1.3.1
> ```

### [pathogen](https://github.com/tpope/vim-pathogen)
```sh
git clone --branch v1.3.1 https://github.com/rishi-opensource/vim-claude-code.git
```
